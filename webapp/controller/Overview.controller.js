    ...
    function (Controller, JSONModel) {
        ...
        return Controller.extend("project1.controller.Overview", {
            onInit() {
                ...
                var olang;
                //Detect the Browser Language and Load the respective i18n Model (Global Resource Model)
                if (navigator.language == "es")
                    ...
                    olang = "i18n";
                //Set the Model to i18n
                var i18nModel = this.getOwnerComponent().getModel(olang);
